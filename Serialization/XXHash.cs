...
namespace EastFive.Serialization
{
    ...
    public static class XXHash
    {
        ...
        public static unsafe uint HashXX32(this ReadOnlySpan<byte> buffer, uint seed = 0)
        {
        ...
        /// <param name="seed">Optional seed.</param>
        /// <returns>32-bit hash value.</returns>
        public static unsafe uint HashXX32(this Stream stream, uint seed = 0)
        {
            const int stripeLength = 16;
        ...
        public static unsafe ulong HashXX64(this byte[] buffer, ulong seed = 0)
            => new ReadOnlySpan<byte>(buffer).HashXX64(seed: seed);
        ...
        public static unsafe ulong HashXX64(this ReadOnlySpan<byte> buffer, ulong seed = 0)
        {
        ...
        /// <param name="seed">Optional seed.</param>
        /// <returns>Computed 64-bit hash value.</returns>
        public static unsafe ulong HashXX64(this Stream stream, ulong seed = 0)
        {
            const int stripeLength = 32;
